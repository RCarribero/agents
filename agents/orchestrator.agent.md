...
```
Siempre                                → skill_installer (Fase -1) → skill_context
¿Hay código existente afectado?        → researcher (Fase 0a) → research_brief
¿Dominio desconocido o tarea compleja? → analyst (Fase 0)
