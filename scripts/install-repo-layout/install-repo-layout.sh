...
install_script "scripts/validate-stack/validate-stack.sh"
install_script "scripts/validate-stack/validate-stack.ps1"
install_script "scripts/validate-agents/validate-agents.sh"
install_script "scripts/validate-agents/validate-agents.ps1"
install_script "scripts/validate-memory/validate-memory.sh"
install_script "scripts/validate-memory/validate-memory.ps1"
install_script "scripts/run-tests/run-tests.sh"
install_script "scripts/run-tests/run-tests.ps1"
install_script "scripts/run-lint/run-lint.sh"
install_script "scripts/run-lint/run-lint.ps1"
install_script "scripts/sandbox-run/sandbox-run.sh"
install_script "scripts/sandbox-run/sandbox-run.ps1"
install_script "scripts/Dockerfile.sandbox"
install_script "scripts/agent-metrics/agent-metrics.sh"
install_script "scripts/agent-metrics/agent-metrics.ps1"
install_script "scripts/rag_indexer.py"
install_script "scripts/run_eval_gate.py"
install_script "scripts/token-report/token-report.sh"
install_script "scripts/token-report/token-report.ps1"
